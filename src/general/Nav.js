...
export const Nav = () => {
    ...
    return (
        ...
        <SubMenu key="subMenuUsuario" icon={<SettingOutlined />} title="Usuarios">
            <Menu.Item onClick={handleClick} key="listarUsuarios" ><Link to={'/login'} className="nav-link">Usuarios</Link></Menu.Item>
